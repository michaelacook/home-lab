...
I will be creating a simple perimeter network with a Pfsense firewall for isolation and to demonstrate the configuration of a remote access VPN, but because the focus of this lab project is on the configuration of essential IT services I will be leaving the network unsegmented. It is possible to create a router-on-a-stick topology with Pfsense, but I decided against doing this here. In a [previous project](https://github.com/michaelacook/cooklab) I configured a ROAS topology with Pfsense and found it added unnecessary complexity for a project that was otherwise focused on application layer technologies.
