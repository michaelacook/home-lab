# Office Domaink: `cooklab.local`

Note: This is an older project I worked on several years ago around the time I was just starting my first IT job. I have since iterated and improved on a lot of what I built out in this project, culminating in a newer project: [Small-Medium Business Active Directory Infrastructure](<../smb-active-directory-infrastructure-pt-1/sm-active-directory-infrastructure-pt1.md>).
